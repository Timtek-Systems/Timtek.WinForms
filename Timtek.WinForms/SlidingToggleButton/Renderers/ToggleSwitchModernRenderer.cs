...
public class ToggleSwitchModernRenderer : ToggleSwitchRendererBase, IDisposable
{
    ...
    public override void RenderButton(Graphics g, Rectangle buttonRectangle)
    {
        ...
        using (var buttonPath = GetRoundedRectanglePath(buttonRectangle, ButtonCornerRadius))
        {
            //Draw button surface
        ...
        //Draw button arrows
        var arrowColor = ArrowNormalColor;
        ...
        arrowRectangle.X = buttonRectangle.X + (int)((buttonRectangle.Width - (double)arrowRectangle.Width) / 2);
        arrowRectangle.Y = buttonRectangle.Y + (int)((buttonRectangle.Height - (double)arrowRectangle.Height) / 2);
    ...
    {
        var buttonWidth = 1.41f * ToggleSwitch.Height;
