...
public class ToggleSwitchPlainAndSimpleRenderer : ToggleSwitchRendererBase
{
    ...
    public override void RenderLeftToggleField(Graphics g, Rectangle leftRectangle, int totalToggleFieldWidth)
    {
        ...
        var innerBorderClipPath = GetInnerBorderClipPath(controlRectangle);
    ...
    public override void RenderButton(Graphics g, Rectangle buttonRectangle)
    {
        ...
        var buttonClipPath = GetButtonClipPath();

        var controlRectangle = new Rectangle(0, 0, ToggleSwitch.Width, ToggleSwitch.Height);
        var outerBorderClipPath = GetControlClipPath(controlRectangle);
        var innerBorderClipPath = GetInnerBorderClipPath(controlRectangle);
        ...
        var borderColor = ToggleSwitch.Checked ? BorderColorChecked : BorderColorUnchecked;
    ...
    {
        var innerBorderRectangle = new Rectangle(controlRectangle.X + BorderWidth,
            controlRectangle.Y + BorderWidth,
            controlRectangle.Width - 2 * BorderWidth,
            controlRectangle.Height - 2 * BorderWidth);

        var borderPath = new GraphicsPath();
        borderPath.AddArc(innerBorderRectangle.X, innerBorderRectangle.Y, innerBorderRectangle.Height, innerBorderRectangle.Height,
            90, 180);
        borderPath.AddArc(innerBorderRectangle.X + innerBorderRectangle.Width - innerBorderRectangle.Height, innerBorderRectangle.Y,
            innerBorderRectangle.Height, innerBorderRectangle.Height, 270, 180);
        borderPath.CloseFigure();
    ...
    public GraphicsPath GetButtonClipPath()
    {
        ...
        buttonPath.AddArc(buttonRectangle.X + ButtonMargin, buttonRectangle.Y + ButtonMargin,
            buttonRectangle.Height - 2 * ButtonMargin, buttonRectangle.Height - 2 * ButtonMargin, 0, 360);
    ...
    {
        var buttonWidth = ToggleSwitch.Height - 2 * BorderWidth;
    ...
    {
        if (buttonWidth <= 0) return Rectangle.Empty;

        var buttonRect = new Rectangle(ToggleSwitch.ButtonValue, BorderWidth, buttonWidth, buttonWidth);
